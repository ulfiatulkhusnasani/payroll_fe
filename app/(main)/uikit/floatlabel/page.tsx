...
const FloatLabelDemo = () => {
    ...
    const [value10, setValue10] = useState<Demo.Country | null>(null);
    const [value11, setValue11] = useState<Demo.Country[] | null>(null);
            ...
            <div className="grid p-fluid mt-3">
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        ...
                        />
                        <label htmlFor="inputtext5">InputText (5)</label>
                    </span>
                </div>
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
